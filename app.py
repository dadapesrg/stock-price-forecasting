...
#model = load_model('results/lstm_stock_model.h5')
...
def predict():
    ...
    print("Before tconversion:", scaled_features)
    ...
    prediction = scaler.inverse_transform(np.zeros((1, 5)) + prediction)[0, 3]  # Assuming 'Close' price is the 4th column
